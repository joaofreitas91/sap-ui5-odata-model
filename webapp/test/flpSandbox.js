		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Stock Control",
									"targetURL": "#comlab2devstockcontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devstockcontrol-display": {
								"semanticObject": "comlab2devstockcontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.stockcontrol",
									"url": sap.ui.require.toUrl("com/lab2dev/stockcontrol")
								}
							}
						}
					}
